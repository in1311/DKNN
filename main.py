...
from run.predict import predict, visualize_field_pre
...
if __name__ == '__main__':
    ...
    if if_save_model is True:
        ...
        RF_diag, result_path = predict(modelname, datapath, train_info, hidden_neuron, pe_weight=pe_weight, top_k=top_k, is_save_result=True)
